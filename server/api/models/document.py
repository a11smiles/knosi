...
from sqlalchemy import Column, String, DateTime, Integer, Text, LargeBinary, UniqueConstraint
...
class Document(Base):
    ...
    # Composite unique constraint: same filename allowed across different vaults
    __table_args__ = (
        UniqueConstraint('filename', 'vault_name', name='uix_filename_vault'),
    )
